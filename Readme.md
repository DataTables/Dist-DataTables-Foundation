# DataTables with [Foundation](https://get.foundation/) styling

This package contains distribution files required to style [DataTables table enhancement library](https://datatables.net) with styling integration for [Foundation](https://get.foundation/).
